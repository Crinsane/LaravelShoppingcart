...
class CartItem implements Arrayable
{
    ...
    /**
     * The price without TAX of the cart item quantity.
     *
     * @var float
     */
    public $qty_price;
    ...
    /**
     * Returns the formatted price without TAX from product quantity.
     *
     * @param int $decimals
     * @param string $decimalPoint
     * @param string $thousandSeperator
     * @return string
     */
    public function qty_price($decimals = 2, $decimalPoint = '.', $thousandSeperator = ',')
    {
        return number_format($this->qty_price, $decimals, $decimalPoint, $thousandSeperator);
    }
    ...
    public function setQuantity($qty)
    {
        ...
        $this->qty = $qty;
        $this->qty_price = $this->price * $this->qty;
    }
    ...
    public function updateFromArray(array $attributes)
    {
        ...
        $this->qty_price = array_get($attributes, 'qty_price', $this->qty_price);
